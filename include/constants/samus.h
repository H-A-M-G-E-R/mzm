...
enum SamusPose {
    SPOSE_RUNNING, // 0x00
    SPOSE_STANDING, // 0x01
    SPOSE_TURNING_AROUND, // 0x02
    SPOSE_SHOOTING, // 0x03
    SPOSE_CROUCHING, // 0x04
    SPOSE_TURNING_AROUND_AND_CROUCHING, // 0x05
    SPOSE_SHOOTING_AND_CROUCHING, // 0x06
    SPOSE_SKIDDING, // 0x07
    SPOSE_MIDAIR, // 0x08
    SPOSE_TURNING_AROUND_MIDAIR, // 0x09
    SPOSE_LANDING, // 0x0A
    SPOSE_STARTING_SPIN_JUMP, // 0x0B
    SPOSE_SPINNING, // 0x0C
    SPOSE_STARTING_WALL_JUMP, // 0x0D
    SPOSE_SPACE_JUMPING, // 0x0E
    SPOSE_SCREW_ATTACKING, // 0x0F
    SPOSE_MORPHING, // 0x10
